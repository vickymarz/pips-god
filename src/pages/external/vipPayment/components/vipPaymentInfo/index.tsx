...
export const VipPaymentInfo = () => {
  return (
    <div>
    <h2 className='pt-[14px] md:pt-[34px] pb-[21px] md:pb-[20px] text-[#19275E] text-[1.06rem] md:text-[2.5rem] font-semibold'>Vip Signal Group | Pips god Academy</h2>
    <div className='flex flex-col justify-start items-start gap-y-[3px] md:gap-y-[6px]'>
       ...
       <h3 className='text-[#000000] font-medium text-[1.31rem] lg:text-[2.75rem]'><FontAwesomeIcon icon={faDollarSign} />100</h3>
    </div>
    <div className='font-medium text-[0.67rem] lg:text-[1.37rem] text-[#000000] flex flex-col justify-start items-start gap-y-[20px] md:gap-y-[40px] mb-[24px]'>
       ...
       <p className='leading-[1rem] md:leading-[2rem]'> Professional guidance <br /> Advanced risk management <br /> One-off Subscription<br /> Precise stop and limit levels to maximize profit</p>
