  ...
  return (
    <section className='bg-[#FFF6E3] bg-no-repeat'>
      <div style={{
          ...
          <h2 className="text-center font-bold text-[1.4rem] md:text-[3rem] leading-[1.7rem] md:leading-[3rem] text-[#494949]">
          ...
          <div className='flex justify-center items-center'>
            ...
            <div className='relative'>
              ...
              <Button type="button" className='rounded-tl-none rounded-br-[10px] bg-[#0D142E] text-[#fff] py-[0.7rem] px-[8px] md:py-[1.5rem] md:px-[1.3rem] text-[0.5rem] md:text-[1.2rem] font-bold'>
