    ...
    <section className='bg-[#F8FAFC] bg-no-repeat px-[1.6rem] md:px-20 py-[1.2rem] md:py-[4rem]'>
      <div className='md:bg-stars bg-no-repeat z-10 flex flex-col md:flex-row justify-start md:justify-between item-center md:gap-x-[4rem] gap-y-[1rem]'>
        <div className='flex flex-col justify-start items-start'>
          ...
          <h2 className="font-bold text-[1.4rem] md:text-[3rem] leading-[1.7rem] md:leading-[3rem] text-[#0D142E] my-[1rem] md:my-[2rem]">The Pipsgod
           <br/> Academy
          </h2>
          ...
          <Button type="button" className='md:mt-[2rem] rounded-[4px] md:rounded-[10px] bg-[#0D142E] text-[#fff] py-[8px] px-[0.5rem] md:py-[1.2rem] md:px-[2.5rem] text-[0.6rem] md:text-base font-bold mt-[0.6rem]'>
            Start Learning
          </Button>
        </div>
