...
export const Intro = () => {
  return (
    <section className="text-center w-[90%] lg:w-[75%] mx-auto px-5 py-5 lg:px-20 pt-[4rem] lg:pt-[11rem] flex flex-col justify-center items center gap-y-[10px] lg:gap-y-[15px] mb-[10px]">
      <h2 className="font-bold text-[22px] lg:text-[65px] leading-[27px] lg:leading-[82px] text-white">The World’s most Powerful Trade Platform.</h2>
