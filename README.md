...
# 📖 Pips god <a name="about-project"></a>
...
```
  cd my-folder
  git clone https://github.com/vickymarz/pips-god.git
```
...
I would like to thank Emmanuel Orji for building the backend of the application
